            ...
            <div class="bg_in">
               <div class="footer footer_bottom">
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           <li><a href="" class="fb"><img src="<?php echo BASE_URL ?>/public/images/fb.jpg" height="30" width="30">Facebook</a></li>
                           <li><a href="#2" class="fb"><img src="<?php echo BASE_URL ?>/public/images/gg.png" height="30" width="30">Google</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Hotline:0943888967</span>
                                    <span class="text_small">(Từ 8h đến 21h tất cả các ngày)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
                           <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  trinhduoc69@gmail.com</a></li>
                           <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i>  http://49-53food.com/</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
