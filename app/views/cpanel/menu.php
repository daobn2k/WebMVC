...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo BASE_URL?>/login/dashboard">
  ...
  <div class="sidebar-brand-text mx-3">Trang Quản Lí</div>
</a>
...
<li class="nav-item">
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseabc" aria-expanded="true" aria-controls="collapseUtilities">
    <i class="fas fa-fw fa-shopping-cart"></i>
    <span>Quản  lý Đơn Hàng </span>
  </a>
  <div id="collapseabc" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <h6 class="collapse-header">Thông Tin:</h6>
