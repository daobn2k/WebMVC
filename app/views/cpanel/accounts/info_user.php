...
<form action="<?php echo BASE_URL?>/dangky/dangky">
<button type = "submit" class = "btn btn-success" style = "margin-bottom:15px">
<i class="fas fa-fw fa-plus-circle" style = "margin-right:5px;"></i>
...
<input type="search" name= "search" class="textbox" placeholder="Điền tên khách hàng muốn tìm ... ">
