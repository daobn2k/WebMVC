...
<body>
    <div id="logreg-forms">
        <form class="form-signin" method="POST" action="<?php echo BASE_URL ?>/login/authentication_login">
            ...
            <a href='<?php echo BASE_URL ?>/dangky/dangky'><span> Đăng Ký Tài Khoản</span></a>
